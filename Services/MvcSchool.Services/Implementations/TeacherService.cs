...
namespace MvcSchool.Services.Implementations
{
    public class TeacherService : ITeacherService
    {
        ...
        public IEnumerable<TeacherProfileFullServiceModel> GetAllTeacherProfilesFull(int page = 1)
        {
            ...
            var allTeacherProfilesFull =  this.db
                ...
                .Take(PageCountSize)
                .Select(x => new TeacherProfileFullServiceModel
            {
                Id = x.Id,
        ...
        public TeacherProfileFullServiceModel GetTeacherProfileFullById(int id)
        {
            var teacherProfileFullById = this.db.Teachers.Where(x => x.Id == id).Select(x => new TeacherProfileFullServiceModel
            {
                Id = x.Id,
                FirstName = x.FirstName,
                MiddleName = x.MiddleName,
