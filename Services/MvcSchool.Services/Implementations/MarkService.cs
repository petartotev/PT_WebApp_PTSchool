...
namespace MvcSchool.Services.Implementations
{
    public class MarkService : IMarkService
    {
        ...
        public void AddNewMarkProfileToStudentByStudentId(MarkProfileFullServiceModel markToAdd)
        {
        ...
        public IEnumerable<MarkProfileFullServiceModel> GetAllMarksProfilesFullByStudentId(int id, int page = 1)
        {     
            return this.db
                .Marks
                ...
                .Take(PageSizeCount)
                .Select(x => new MarkProfileFullServiceModel
            {
                Id = x.Id,
